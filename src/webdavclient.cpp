...
{
	return client->download(ppath, outputfile, [](void *context, size_t dltotal, size_t dlnow, size_t ultotal, size_t ulnow) { bytes_transfered = dlnow; return 1; });
}
...
{
	return client->upload(ppath, inputfile, [](void *context, size_t dltotal, size_t dlnow, size_t ultotal, size_t ulnow) { bytes_transfered = ulnow; return 1; });
}
