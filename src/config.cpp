...
namespace CONFIG {
    ...
    void LoadConfig()
    {
        ...
        for (int i=0; i <sites.size(); i++)
        {
            ...
            WriteString(sites[i].c_str(), CONFIG_WEBDAV_SERVER, setting.server);
        ...
        void *f = FS::OpenRead(WEBDAV_CLIENT_VERSION_PATH);
    ...
    void SaveConfig()
    {
        ...
        WriteString(last_site, CONFIG_WEBDAV_SERVER, webdav_settings->server);
